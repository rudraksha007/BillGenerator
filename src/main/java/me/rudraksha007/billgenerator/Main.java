...
import me.rudraksha007.billgenerator.GUI2.Home;
...
//    public static Map<String, Map<String, Item>>items = (Map<String, Map<String, Item>>) dataManager.loadData("products.data");
